---
title: Working with content tokens in XM Cloud
...
Currently I'm resposible for helping a bank transition from Sitecore XP 10.3 on premise, traditional MVC towards a headless architecture. 
...
I did however learn lots and found that the Plugin system that Sitecore created is built with great care and gives developers the oppertunity to hook into that ecosystem quite easily. 
